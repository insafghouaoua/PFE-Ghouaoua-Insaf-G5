...
$produit = $pdo->query("SELECT * FROM produit WHERE categorie_id='2002'");
		...
		echo'					<!--/ End Single Widget -->';
					...
					echo'	<div class="col-lg-9 col-md-8 col-12">';
							...
							if (isset($_GET["search"])) {
								...
								// Prepare and execute the SQL query to search for products by name in the "produits-jardinage" category
								$sql = "SELECT * FROM produit WHERE categorie_id = '2002' AND nom LIKE :searchTerm";
								$stmt = $pdo->prepare($sql);
