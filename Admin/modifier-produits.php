...
if (isset($_GET['modifierid'])) {
  $produit_id = $_GET['modifierid'];
  $stmt = $pdo->prepare('SELECT * FROM produit WHERE produit_id = :produit_id');
  $stmt->execute (array('produit_id' => $produit_id));
       ...
       $statut = trim($_POST['statut']);
        ...
        if (empty($_POST['description']) ){
            ...
            $success['description']="";
                ...
                $sql = "UPDATE produit SET categorie_id=:categorie_id, categorie=:categorie, nom=:nom, marque=:marque, petite_description=:petite_description, description=:description, image=:image, prix_initial=:prix_initial, prix_vente=:prix_vente, quantite=:quantite, statut=:statut WHERE produit_id=:produit_id";
                try{
                    ...
                    $success['inscription'] = 'Les informations du produit ont bien été modifier.';
                }
...
// Create the dropdown list with the category names
...
?>
        ...
        <input type="text" placeholder="nom" name="nom" id="nom" value="<?php echo isset($_POST['nom']) ? $_POST['nom'] : $produit['nom']; ?>">
        ...
        <small><?php echo isset($success['nom']) ? $success['nom'] : ''; ?></small>
            ...
            <label for="marque">Marque* :</label>
              <input type="text" placeholder="marque" name="marque" id="marque" value="<?php echo isset($_POST['marque']) ? $_POST['marque'] : $produit['marque']; ?>">
            ...
            <label for="petite_description">Petite description* :</label>
              <input type="text" placeholder="petite_description" name="petite_description" id="petite_description" value="<?php echo isset($_POST['petite_description']) ? $_POST['petite_description'] : $produit['petite_description']; ?>">
            ...
            <label for="description">Description* :</label>
              <input type="text" placeholder="description" name="description" id="description" value="<?php echo isset($_POST['description']) ? $_POST['description'] : $produit['description']; ?>">
            ...
            <label for="image">Image* :</label>
              <input type="file" placeholder="image" name="image" id="image" value="<?php echo isset($_POST['image']) ? $_POST['image'] : $produit['image']; ?>">
            ...
            <label for="prix_initial">Prix initial* :</label>
              <input type="num" placeholder="prix_initial" name="prix_initial" id="prix_initial" value="<?php echo isset($_POST['prix_initial']) ? $_POST['prix_initial'] : $produit['prix_initial']; ?>">
            ...
            <label for="prix_vente">Prix de vente* :</label>
              <input type="num" placeholder="prix_vente" name="prix_vente" id="prix_vente" value="<?php echo isset($_POST['prix_vente']) ? $_POST['prix_vente'] : $produit['prix_vente']; ?>">
            ...
            <label for="quantite">Quantite* :</label>
              <input type="num" placeholder="quantite" name="quantite" id="quantite" value="<?php echo isset($_POST['quantite']) ? $_POST['quantite'] : $produit['quantite']; ?>">
        ...
        <option id="statut" name="statut" value="en_stock"<?php echo (isset($_POST['statut']) && $_POST['statut'] == 'en_stock') ? ' selected' : ''; ?>>En stock</option>
        <option id="statut" name="statut" value="en_rupture_de_stock"<?php echo (isset($_POST['statut']) && $_POST['statut'] == 'en_rupture_de_stock') ? ' selected' : ''; ?>>En rupture de stock</option>
        <option id="statut" name="statut" value="non_disponible"<?php echo (isset($_POST['statut']) && $_POST['statut'] == 'non_disponible') ? ' selected' : ''; ?>>Non disponible</option>
        <option id="statut" name="statut" value="nouveaute"<?php echo (isset($_POST['statut']) && $_POST['statut'] == 'nouveaute') ? ' selected' : ''; ?>>Nouveauté</option>
        <option id="statut" name="statut" value="en_promo"<?php echo (isset($_POST['statut']) && $_POST['statut'] == 'en_promo') ? ' selected' : ''; ?>>En promo</option>
        ...
        <small><?php echo isset($success['statut']) ? $success['statut'] : ''; ?></small>
                        ...
                        <button class="connexion-button" type="button" onclick="window.location.href='produits.php'">Annuler</button>
