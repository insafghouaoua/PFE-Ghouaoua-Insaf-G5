...
<head>
    ...
    <title>Offres produits jardinage</title>
    	<!-- Favicon -->
...
<table>
  ...
  $offre = $pdo->query('SELECT *, offre_achat_partage.nom AS offre_achat_partage_nom  FROM offre_achat_partage  JOIN produit ON offre_achat_partage.produit_id = produit.produit_id WHERE produit.categorie = "Produits de jardinage et d\'extérieur" ORDER BY offre_achat_partage.produit_id');
...
while($ligne = $offre->fetch()){ 
  ...
  echo '</tr>';
    ...
    echo '<th>Supprimer</th>';
    echo '</tr>';
    $commentaire = $pdo->query('SELECT *, participation_achat_partage.nom AS participation_achat_partage_nom  FROM participation_achat_partage JOIN produit ON participation_achat_partage.produit_id = produit.produit_id WHERE produit.categorie = "Produits de jardinage et d\'extérieur" ORDER BY participation_achat_partage.produit_id');
