...
$commentaire = $pdo->query('SELECT *, commentaire.nom AS commentaire_nom FROM commentaire JOIN produit ON commentaire.produit_id = produit.produit_id WHERE produit.categorie = "Produits de loisirs" ORDER BY commentaire.produit_id');
