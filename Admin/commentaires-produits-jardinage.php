...
<head>
    ...
    <title>Commentaires Produits jardinage</title>
	<!-- Favicon -->
...
$commentaire = $pdo->query('SELECT *, commentaire.nom AS commentaire_nom FROM commentaire JOIN produit ON commentaire.produit_id = produit.produit_id WHERE produit.categorie = "Produits de jardinage et d\'extérieur" ORDER BY commentaire.produit_id');

if ($commentaire->rowCount() == 0) {
  echo '<tr>';

  echo '<td colspan="8">Aucun commentaire pour cette categorie.</td>';
  echo '</tr>';
