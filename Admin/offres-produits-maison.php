...
<head>
    ...
    <title>Offres produits maison</title>
    	<!-- Favicon -->
...
<table>
  ...
  $offre = $pdo->query('SELECT *, offre_achat_partage.nom AS offre_achat_partage_nom FROM offre_achat_partage  JOIN produit ON offre_achat_partage.produit_id = produit.produit_id WHERE produit.categorie = "Articles pour la maison" ORDER BY offre_achat_partage.produit_id');
...
while($ligne = $offre->fetch()){ 
  ...
  echo '</tr>';
    ...
    echo '<th>Supprimer</th>';
    echo '</tr>';
    $commentaire = $pdo->query('SELECT *, participation_achat_partage.nom AS participation_achat_partage_nom  FROM participation_achat_partage JOIN produit ON participation_achat_partage.produit_id = produit.produit_id WHERE produit.categorie = "Articles pour la maison" ORDER BY participation_achat_partage.produit_id');

    $participation = $pdo->prepare('SELECT * FROM participation_achat_partage WHERE offre_id = :offre_id ORDER BY produit_id');
