...
if (isset($_GET['modifierid'])) {
  $administrateur_id = $_GET['modifierid'];
  $stmt = $pdo->prepare('SELECT * FROM administrateur WHERE administrateur_id = :administrateur_id');
  $stmt->execute (array('administrateur_id' => $administrateur_id));
...
if(isset($_POST['submit'])) {
        ...
        $administrateur_id = $_POST['administrateur_id'];
        ...
        if (empty($_POST['confirmation_mot_de_passe']) ){
          ...
          if (empty($errors)) {
             $sql = "UPDATE administrateur SET image_profile=:image_profile, nom=:nom, prenom=:prenom, datedenaissance=:datedenaissance, genre=:genre, email=:email, telephone=:telephone, `mot_de_passe`=:mot_de_passe WHERE administrateur_id=:administrateur_id";
                try{
                  ...
                  $success['inscription'] = 'Vos informations ont bien été modifier.';
              }
...
<div class="content ">
  ...
  <input type="hidden" name="administrateur_id" value="<?php echo $administrateur_id; ?>">
  ...
  <div class="form-control image_profile">
        ...
        <input type="text" placeholder="Nom" name="nom" id="nom" value="<?php echo isset($_POST['nom']) ? $_POST['nom'] : $administrateur['nom']; ?>">
        ...
        <small><?php echo isset($success['nom']) ? $success['nom'] : ''; ?></small>
            ...
            <label for="prenom">Prenom* :</label>
              <input type="text" placeholder="Prenom" name="prenom" id="prenom" value="<?php echo isset($_POST['prenom']) ? $_POST['prenom'] : $administrateur['prenom']; ?>">
            ...
            <input type="date" id="datedenaissance" name="datedenaissance" value="<?php echo isset($_POST['datedenaissance']) ? $_POST['datedenaissance'] : $administrateur['datedenaissance']; ?>">
            ...
            <div class="radioinputgenre">
                ...
                <label for="email">Email* :</label>
                    <input type="email" placeholder="Adresse email" name="email" id="email" value="<?php echo isset($_POST['email']) ? $_POST['email'] : $administrateur['email']; ?>">
                ...
                <label for="telephone">Numero de telephone :</label>
                    <input type="tel" placeholder="Numero de telephone" name="telephone" id="telephone" value="<?php echo isset($_POST['telephone']) ? $_POST['telephone'] : $administrateur['telephone']; ?>">
                    ...
                    <label for="mot_de_passe">Mot de passe* :</label>
                     <input type="password" placeholder="Mot de passe" name="mot_de_passe" id="mot_de_passe" value="<?php echo isset($_POST['mot_de_passe']) ? $_POST['mot_de_passe'] : $administrateur['mot_de_passe']; ?>">
                     ...
                     <small><?php echo isset($success['mot_de_passe']) ? $success['mot_de_passe'] : ''; ?></small>
                         ...
                         <label for="confirmation_mot_de_passe">Confirmez le mot de passe* :</label>
                           <input type="password" placeholder="Confirmez mot de passe" name="confirmation_mot_de_passe" id="confirmation_mot_de_passe" value="<?php echo isset($_POST['mot_de_passe']) ? $_POST['mot_de_passe'] : $administrateur['mot_de_passe']; ?>">
                        ...
                        <button class="connexion-button" type="button" onclick="window.location.href='profile.php'">Annuler</button>
